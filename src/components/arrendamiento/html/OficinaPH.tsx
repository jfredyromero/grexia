            ...
            >
                ...
                <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="text-right">
                        ...
                        <p className="text-[9px] text-slate-500 mt-1">Contrato de Oficina - Propiedad Horizontal</p>
                    </div>
                </div>
                ...
                <p className="mb-5 text-justify">
                    ...
                    voluntaria, y se denominará el <strong>&quot;ARRENDATARIO&quot;</strong>, manifestaron que han
                    decidido celebrar un contrato de arrendamiento de oficina(s), en adelante el{' '}
                ...
                <div className="space-y-4 text-justify">
                    ...
                    <div>
                        <p>
                            <strong>Séptima. &ndash; Reparaciones: </strong>Los daños que se ocasionen al Inmueble por
                            el Arrendatario, por responsabilidad suya o de sus dependientes, serán reparados y cubiertos
                    ...
                    <div>
                        <p>
                            ...
                            Inmueble permanezca abandonado o deshabitado por el término de dos (2) meses o más y/o que
                            la exposición al riesgo sea tal que amenace la integridad física del bien o la seguridad del
                            vecindario.
                        </p>
                    </div>
