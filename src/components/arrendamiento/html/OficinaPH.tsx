...
export default function OficinaPHTemplate({ formData, plan = 'free', logoUrl }: OficinaPHProps) {
        ...
        >
            ...
            >
                ...
                <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="text-right">
                        ...
                        <p className="text-[9px] text-slate-500 mt-1">
                            Contrato de Oficina - Propiedad Horizontal
                        </p>
                    </div>
                </div>
                ...
                <p className="mb-5 text-justify">
                    ...
                    <strong>&quot;ARRENDATARIO&quot;</strong>, manifestaron que han decidido celebrar un contrato
                    de arrendamiento de oficina(s), en adelante el <strong>&quot;CONTRATO&quot;</strong>, el cual
                ...
                <div className="space-y-4 text-justify">
                    ...
                    <div>
                        <p>
                            ...
                            {inmueble.areaMq ? `, con área aproximada de ${inmueble.areaMq} m²` : ''}{inmueble.estrato ? `, estrato ${inmueble.estrato}` : ''}.
                        </p>
                    </div>
                    ...
                    <div>
                        <p>
                            ...
                            concenso de las partes, dentro de los primeros{' '}
                    ...
                    <div>
                        <p>
                            ...
                            anterior sin perjuicio del derecho a la renovación consagrado en el Artículo 518 del
                            Código de Comercio.
                        </p>
                    </div>
                    ...
                    <div>
                        <p>
                            <strong>Séptima. &ndash; Reparaciones: </strong>Los daños que se ocasionen al
                            ...
                            En todo caso, el Arrendatario se obliga a restituir el Inmueble en el mismo estado en
                            que lo ha recibido, salvo el deterioro natural por el uso legitimo. Las reparaciones
                            locativas al Inmueble estarán a cargo del Arrendatario y las estructurales a cargo del
                            Arrendador.
                        </p>
                        <p className="mt-2">
                    ...
                    <div>
                        <p>
                            <strong>Décima. &ndash; Restitución: </strong>Vencido el periodo inicial o la última
                    ...
                    <div>
                        <p>
                            ...
                            elija: (I) Declarar terminado este Contrato y reclamar la devolución del Inmueble
                            judicial, policial y/o extrajudicialmente. (II) Exigir y perseguir a través de
                            cualquier medio, judicial o extrajudicialmente, al Arrendatario por el monto de los
                            perjuicios resultantes del incumplimiento, así como de la multa por incumplimiento
                    ...
                    <div>
                        ...
                        <p className="mt-2">
                            <strong>Parágrafo: </strong>Las Partes acuerdan que cualquier copia de este Contrato
                    ...
                    <div>
                        <p>
                            ...
                            de dos (2) meses o más y/o que la exposición al riesgo sea tal que amenace la
                    ...
                    <div>
                        {coarrendatario ? (
                            <p>
                                ...
                                <strong>{coarrendatario.nombreCompleto || '_______________'}</strong>, mayor de
                                edad, identificado(a) con {CO_DOC}, quien para efectos de este Contrato obra en
                            ...
                            <p>
                                ...
                                Para garantizar al Arrendador el cumplimiento de las obligaciones a cargo del
                                Arrendatario, el Arrendatario tiene como coarrendatario a{' '}
                                <span className="underline decoration-dotted">_______________</span>, mayor de
                                edad, identificado(a) con cédula de ciudadanía No.{' '}
                                <span className="underline decoration-dotted">_______________</span>, quien para
                                efectos de este Contrato obra en nombre propio, quienes declaran que se obligan
                                de manera solidaria con el Arrendatario y frente al Arrendador durante el
