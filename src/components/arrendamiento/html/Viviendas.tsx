        ...
        >
            ...
            >
                ...
                <p className="mb-5 text-justify">
                    ...
                    con {ARR_DOC}, quien obra en nombre propio, de manera libre expresa y voluntaria, y que para
                    efectos de este contrato se denominará el <strong>ARRENDADOR</strong>; y por la otra parte,{' '}
                ...
                >
                    ...
                    <p className="text-[11px] text-slate-800 leading-snug mb-1">
                        <strong>Forma de pago:</strong> Mensual, por adelantado, dentro de los primeros {diaPago}{' '}
                        días de cada mes.
                    </p>
                    <p className="text-[11px] text-slate-800 leading-snug mb-1">
                        <strong>Lugar:</strong> En las oficinas o residencia del Arrendador, o lugar pactado por
                        las partes.
                    </p>
                    <p className="text-[11px] text-slate-800 leading-snug mb-1">
                ...
                <div className="space-y-4 text-justify">
                    ...
                    <div>
                        <p>
                            ...
                            y habitacion del Arrendatario identificado así:{' '}
                            <strong>
                                {inmueble.direccion
                                    ? `${inmueble.direccion}, ${ciudadStr}`
                                    : '___________________'}
                            </strong>
                            {inmueble.areaMq ? `, con área aproximada de ${inmueble.areaMq} m²` : ''}
                            {inmueble.estrato ? `, estrato ${inmueble.estrato}` : ''}, destinado exclusivamente
                            para el uso de vivienda del Arrendatario y la de su nucleo familiar, en adelante
                            identificado como el <strong>&quot;INMUEBLE&quot;</strong>.
                        </p>
                    </div>
                    ...
                    <div>
                        <p>
                            <strong>Segunda. &ndash; Canon de Arrendamiento: </strong>El canon de arrendamiento
                            ...
                            oficinas, residencia del Arrendador, y/o lugar pactado entre las partes que puede
                            variar según consenso de las partes, dentro de los primeros{' '}
                            <strong>{diaPago}</strong> días de cada mes. El arrendatario tambien puede pagar el
                            canon de arrendamiento en la cuenta bancaria, aplicación móvil, plataforma financiera
                            de identificación que indique el Arrendador. Cada doce (12) meses de ejecución del
                            Contrato, el valor del canon de arrendamiento será reajustado en una proporción
                            convenida entre las partes, sin exceder en todo caso el límite máximo de reajuste
                            fijado por la ley, superintendencia y entidades que regulen el funcionamiento y
                            ejecución del contrato.
                        </p>
                        <p className="mt-2">
                            <strong>Parágrafo 1: </strong>Si el limite máximo de reajuste del canon de
                    ...
                    <div>
                        <p>
                            ...
                            <strong>{duracionLabel}</strong> contados a partir del <strong>{fechaStr}</strong>.
                            No obstante lo anterior, el término del arrendamiento se prorrogará automáticamente
                            por periodos consecutivos iguales al inicial siempre que cada una de las partes haya
                            cumplido con las obligaciones a su cargo y el Arrendatario se avenga a los reajustes
                            de la renta autorizados por ley. En caso de que alguna de las Partes desee terminar
                            el Contrato deberá cumplir los presupuestos de los artículos 22, 23, 24 y 25 del
                    ...
                    <div>
                        <p>
                            <strong>Cuarta. &ndash; Entrega: </strong>El Arrendatario en la fecha de suscripción
                            de este documento declara recibir el Inmueble de manos del Arrendador saneado, en
                            perfecto estado, de conformidad con el inventario elaborado por las partes (de
                            existir) y que forma parte integrante de este contrato.
                        </p>
                    </div>
                    ...
                    <div>
                        <p>
                            <strong>Quinta. &ndash; Reparaciones: </strong>Los daños que se ocasionen al
                            ...
                            Igualmente, el Arrendatario se obliga a cumplir con las obligaciones previstas en los
                            artículos 2029 y 2030 del Código Civil.
                        </p>
                        <p className="mt-2">
                            ...
                            al Inmueble serán del propietario del Inmueble y no habrá lugar al reconocimiento del
                            precio, costo o indemnización alguna al Arrendatario por las mejoras realizadas. Las
                            mejoras no podrán retirarse salvo que el Arrendador lo exija por escrito, a lo que el
                            Arrendatario accederá inmediatamente a su costa, dejando el Inmueble en el mismo buen
                            estado en que lo recibió del Arrendador, salvo el deterioro natural por el uso
                            legitimo.
                        </p>
                    </div>
                    ...
                    <div>
                        <p>
                            <strong>Sexta. &ndash; Servicios Públicos: </strong>El Arrendatario pagará oportuna
                            ...
                            Arrendador podrá abstenerse de pagar los servicios públicos a cargo del Arrendatario,
                            sin que por ello el Arrendatario pueda alegar responsabilidad del Arrendador.
                        </p>
                        <p className="mt-2">
                    ...
                    <div>
                        <p>
                            <strong>Séptima. &ndash; Destinación: </strong>El Arrendatario, durante la vigencia
                            del Contrato, destinará el Inmueble única y exclusivamente para su vivienda y la de
                            su familia. En ningún caso el Arrendatario podrá subarrendar o ceder en todo o en
                            parte este arrendamiento, so pena de que el Arrendador pueda dar por terminado
                            validamente el Contrato en forma inmediata, sin lugar a indemnización alguna en favor
                            del Arrendatario y podrá exigir la devolución del Inmueble sin necesidad de ningún
                            tipo de requerimiento previo por parte del Arrendador. Igualmente, el Arrendatario se
                            abstendrá de guardar o permitir que dentro del Inmueble se guarden semovientes o
                            animales domésticos y/o elementos inflamables, tóxicos, insalubres, explosivos o
                            dañosos para la conservación, higiene, seguridad y estética del inmueble y en general
                            de sus ocupantes permanentes o transitorios.
                        </p>
                        <p className="mt-2">
                            ...
                            y dinero de los grupos terroristas. No destinará el inmueble para la elaboración,
                    ...
                    <div>
                        <p>
                            ...
                            meses, debidamente canceladas por el Arrendatario, bajo el entendido que hará entrega
                            de dichas facturas en el domicilio del Arrendador, con una antelación de dos (2) días
                            hábiles a la fecha fijada para la restitución material del Inmueble al Arrendador. Lo
                            anterior puede modificarse a conveniencia y consenso de las partes.
                        </p>
                        <p className="mt-2">
                    ...
                    <div>
                        <p>
                            <strong>Novena. &ndash; Renuncia: </strong>El Arrendatario declara que (I) no ha
                    ...
                    <div>
                        <p>
                            <strong>Décima. &ndash; Cesión: </strong>El Arrendatario faculta al Arrendador a
                            ceder total o parcialmente este Contrato y declara al cedente del Contrato, es decir
                            al Arrendador, libre de cualquier responsabilidad como consecuencia de la cesión que
                    ...
                    <div>
                        <p>
                            <strong>Décima Primera. &ndash; Incumplimiento: </strong>El incumplimiento del
                        ...
                        <ul className="mt-2 space-y-1 pl-2">
                            <li className="flex gap-2">
                                ...
                                <span>
                                    Declarar terminado este Contrato y reclamar la devolución por vía policial,
                            ...
                            <li className="flex gap-2">
                                ...
                                <span>
                                    ...
                                    extrajudicialmente, al Arrendatario y/o coarrendatarios por el monto de los
                    ...
                    <div>
                        <p>
                            <strong>Décima Segunda. &ndash; Validez: </strong>El presente Contrato anula todo
                    ...
                    <div>
                        <p>
                            <strong>Décima Tercera. &ndash; Merito Ejecutivo: </strong>El Arrendatario declara
                            ...
                            pagadas por el Arrendatario por concepto de servicios públicos del Inmueble, cuotas
                            de administración y cualquier otra suma de dinero que por cualquier concepto deba ser
                    ...
                    <div>
                        <p>
                            <strong>Décima Cuarta. &ndash; Costos: </strong>Cualquier costo que se cause con
                    ...
                    <div>
                        <p>
                            <strong>Décima Sexta. &ndash; Preaviso: </strong>El Arrendador podrá dar por
                            terminado el presente Contrato de conformidad con los artículos 22 y 23 del capitulo
                    ...
                    <div>
                        <p>
                            <strong>Décima Séptima. &ndash; Cláusula Penal: </strong>En el evento de
                            incumplimiento cualquiera de las Partes a las obligaciones a su cargo contenidas en
                            la ley o en este Contrato, la parte incumplida deberá pagar a la otra parte una suma
                    ...
                    <div>
                        <p>
                            <strong>Décima Octava. &ndash; Autorización: </strong>El Arrendatario autoriza
                            ...
                            privada, estatal o gubernamental del comportamiento financiero y crediticio, o
                            centrales de riesgo que existan en el país, así como a reportar a dichas bases de
                            datos cualquier incumplimiento del Arrendatario a este Contrato.
                        </p>
                    </div>
                    ...
                    <div>
                        <p>
                            <strong>Décima Novena. &ndash; Abandono: </strong>El Arrendatario autoriza de manera
                    ...
                    <div>
                        <p>
                            <strong>Vigésima. &ndash; Recibos de pago de servicios públicos: </strong>El
                            Arrendador en cualquier tiempo durante la vigencia de este Contrato, podrá exigir del
                            Arrendatario la presentación de las facturas de los servicios públicos del Inmueble a
                            fin de verificar la cancelación de los mismos. En el evento que el Arrendador llegare
                            a comprobar que alguna de las facturas no ha sido pagada por el Arrendatario
                            encontrándose vencido el plazo para el pago previsto en la respectiva factura, el
                            Arrendador podrá terminar de manera inmediata este Contrato y exigir del Arrendatario
                            el pago de las sumas a que hubiere lugar.
                        </p>
                    </div>
                    ...
                    <div>
                        <p>
                            <strong>Vigésima Primera. &ndash; Coarrendatarios: </strong>Para garantizar al
                            ...
                            nombre propio, quien declara que se obliga de manera{' '}
