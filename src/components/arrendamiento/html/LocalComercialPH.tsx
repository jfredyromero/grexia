        ...
        >
            ...
            >
                ...
                <p className="mb-5 text-justify">
                    ...
                    con la Cédula {ATA_DOC}, quien para efectos de este contrato obra en nombre propio y que se
                    denominará el <strong>ARRENDATARIO</strong>, manifestaron que han decidido celebrar un contrato de
                    arrendamiento de local comercial, en adelante el <strong>&quot;Contrato&quot;</strong>, el cual se
                ...
                <div className="space-y-4 text-justify">
                    ...
                    <div>
                        <p>
                            ...
                            alinderado en la Cláusula Primera del presente Contrato, forma parte del{' '}
                    ...
                    <div>
                        <p>
                            <strong>Cuarta. &ndash; Reajuste del Canon de Arrendamiento: </strong>Cada doce (12) meses
                    ...
                    <div>
                        <p>
                            <strong>Sexta. &ndash; Entrega: </strong>El Arrendatario en la fecha de suscripción de este
                            ...
                            contrato (de existir), y (II) que conoce en su integridad el texto del Reglamento de
                            Propiedad Horizontal aplicable al Inmueble y que lo respetará y lo hará respetar en su
                            integridad, documento que se entiende incorporado a este Contrato.
                        </p>
                    </div>
                    ...
                    <div>
                        <p>
                            <strong>Séptima. - Reparaciones: </strong>Los daños que se ocasionen al Inmueble por el
                    ...
                    <div>
                        <p>
                            <strong>Octava. &ndash; Servicios Públicos: </strong>El Arrendatario pagará oportuna y
                    ...
                    <div>
                        <p>
                            <strong>Novena. &ndash; Destinación: </strong>El Arrendatario, durante la vigencia del
                    ...
                    <div>
                        <p>
                            <strong>Décima. - Restitución: </strong>Vencido el periodo inicial o la última prórroga del
                            Contrato, el Arrendatario (I) restituirá el Inmueble al Arrendador en las mismas buenas
                            condiciones en que lo recibió del Arrendador, salvo el deterioro natural causado por el uso
                            legítimo, (II) entregará al Arrendador los ejemplares originales de las facturas de cobro
                            por concepto de servicios públicos del Inmueble correspondientes a los últimos tres (3)
                            meses, debidamente canceladas por el Arrendatario, bajo el entendido que hará entrega de
                            dichas facturas en el domicilio del Arrendador, con una antelación de dos (2) días hábiles a
                            la fecha fijada para la restitución material del Inmueble al Arrendador.
                        </p>
                        <p className="mt-2">
                    ...
                    <div>
                        <p>
                            <strong>Décima Primera. &ndash; Renuncia: </strong>El Arrendatario declara que renuncia en
                            beneficio del Arrendador o de su cesionario, a todo requerimiento para constituirlo en mora
                    ...
                    <div>
                        <p>
                            <strong>Décima Segunda. &ndash; Cesión: </strong>El Arrendatario faculta al Arrendador a
                    ...
                    <div>
                        <p>
                            <strong>Décima Tercera. &ndash; Incumplimiento: </strong>El incumplimiento del Arrendatario
                        ...
                        <p className="mt-2">
                            (I) Declarar terminado este Contrato y reclamar la devolución del Inmueble judicial y/o
                    ...
                    <div>
                        <p>
                            <strong>Décima Cuarta. &ndash; Validez: </strong>El presente Contrato anula todo convenio
                    ...
                    <div>
                        <p>
                            <strong>Décima Sexta. &ndash; Merito Ejecutivo: </strong>El Arrendatario declara de manera
                    ...
                    <div>
                        <p>
                            <strong>Décima Séptima. &ndash; Costos: </strong>Cualquier costo que se cause con ocasión de
                    ...
                    <div>
                        <p>
                            <strong>Décima Octava. &ndash; Cláusula Penal: </strong>En el evento de un incumplimiento
                    ...
                    <div>
                        <p>
                            <strong>Vigésima Segunda. &ndash; Impuestos </strong>El valor del impuesto de timbre que
