...
export default function ViviendasPHTemplate({ formData, plan = 'free', logoUrl }: ViviendasPHProps) {
                ...
                <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="text-right">
                        ...
                        <p className="text-[9px] text-slate-500 mt-1">
                            Contrato de Vivienda Urbana - Propiedad Horizontal
                        </p>
                    </div>
                </div>
