        ...
        <Document language="es-CO">
            ...
            >
                ...
                <Text style={s.introPara}>
                    ...
                    denominará el <B>{'"'}ARRENDATARIO{'"'}</B>, manifestaron que han decidido celebrar un contrato de
                    arrendamiento de oficina(s), en adelante el <B>{'"'}CONTRATO{'"'}</B>, el cual se rige por las siguientes
                    cláusulas:
                </Text>
                ...
                >
                    ...
                    y/o que la exposición al riesgo sea tal que amenace la integridad física del bien o la seguridad del
                    vecindario.
                </Clause>
