...
interface OficinaPDFProps {
    formData: ArrendamientoFormData;
    plan: PlanTier;
    logoUrl?: string;
}

export default function OficinaPDF({ formData, plan, logoUrl }: OficinaPDFProps) {
        ...
        <Document language="es-CO">
            ...
            >
                ...
                >
                    ...
                    del Arrendador en perfecto estado, de conformidad con el inventario elaborado por las Partes y que
                    forma parte integrante de este contrato (de existir).
                </Clause>
                ...
                >
                    ...
                    prorrogas estará a cargo de la parte que asume estos costos.
                </Clause>
