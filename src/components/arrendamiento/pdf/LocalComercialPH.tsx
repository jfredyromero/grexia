...
interface LocalComercialPHPDFProps {
    formData: ArrendamientoFormData;
    plan: PlanTier;
    logoUrl?: string;
}

export default function LocalComercialPHPDF({ formData, plan, logoUrl }: LocalComercialPHPDFProps) {
        ...
        <Document language="es-CO">
            ...
            >
                ...
                <PDFHeader
                    ...
                    logoUrl={logoUrl}
                    title="ARRENDAMIENTO"
                    subtitle="Contrato de Local Comercial - Propiedad Horizontal"
                />
                ...
                >
                    ...
                    (nombre del edificio o centro) el cual se encuentra ubicado en el área urbana de la ciudad de{' '}
                    <B>{ciudadStr}</B>, sometido al Régimen de Propiedad Horizontal, según consta en (Indicar Número de
                    Escritura Pública del Reglamento de Propiedad Horizontal, Notaría, Fecha y Ciudad), debidamente
                    registrada en la oficina de Instrumentos Públicos de la ciudad de <B>{ciudadStr}</B>.
                </Clause>
                ...
                >
                    ...
                    que forma parte integrante de este contrato (de existir), y (II) que conoce en su integridad el
                    texto del Reglamento de Propiedad Horizontal aplicable al Inmueble y que lo respetará y lo hará
                    respetar en su integridad, documento que se entiende incorporado a este Contrato.
                </Clause>

                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Séptima. - Reparaciones: </Text>
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Octava. – Servicios Públicos: </Text>
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Novena. – Destinación: </Text>
                    ...
                    <Para label="Parágrafo">
                        ...
                        cocaína, meta y similares. El Arrendatario faculta al Arrendador para que, directamente o a
                        través de sus funcionarios debidamente autorizados por escrito, visiten el Inmueble para
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Décima. - Restitución: </Text>
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Décima Tercera. – Incumplimiento: </Text>
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Décima Quinta. – </Text>
                        El Arrendatario autoriza al Arrendador (de ser necesario) a buscar y obtener informacion sobre
                        sus posibles salarios, tiulos y propiedades en entiedades tanto privadas como publicas; como lo
                        pueden ser: bancos, instituciones de credito, la Oficina de Registro de Instrumentos Publicos,
                        entre otros.
                    </Text>
                </View>
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Décima Sexta. – Merito Ejecutivo: </Text>
                    ...
                    <Para label="Parágrafo">
                        Las Partes acuerdan que cualquier copia I de este Contrato tendrá mismo valor que el original
                        para efectos judiciales y extrajudiciales.
                    </Para>
                </View>
                ...
                >
                    En el evento de un incumplimiento cualquiera de las Partes a las obligaciones a su cargo contenidas
                    en la ley o en este Contrato, la Parte incumplida deberá pagar a la otra Parte una suma equivalente
                    a <B>3 cánones</B> de arrendamiento vigentes en la fecha del incumplimiento, a título de pena. En el
                ...
                >
                    ...
                    alguna de las facturas no ha sido pagadas por el Arrendatario encontrándose vencido el plazo para el
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Vigésima Segunda. – Impuestos </Text>
