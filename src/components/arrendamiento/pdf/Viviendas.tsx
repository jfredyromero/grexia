...
export default function ViviendasPDF({ formData }: ViviendasPDFProps) {
    ...
    const arrendadorDoc = arrendador.tipoDocumento === 'NIT' ? 'NIT' : 'cedula de ciudadanía';
        ...
        <Document language="es-CO">
            ...
            >
                ...
                >
                    ...
                    urbano destinado al uso y habitacion del Arrendatario identificado así: <B>{inmuebleDesc}</B>
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        ...
                        residencia del Arrendador, y/o lugar pactado entre las partes que puede variar según consenso de
                        las partes, dentro de los primeros <B>{diaPago}</B> días de cada mes. El arrendatario tambien
                        puede pagar el canon de arrendamiento en la cuenta bancaria, aplicación móvil, plataforma
                        financiera de identificación que indique el Arrendador.{'\n'}Cada doce (12) meses de ejecución
                        del Contrato, el valor del canon de arrendamiento será reajustado en una proporción convenida
                        entre las partes, sin exceder en todo caso el límite máximo de reajuste fijado por la ley,
                        superintendencia y entidades que regulen el funcionamiento y ejecución del contrato.
                    </Text>
                    <Para label="Parágrafo 1">
                        Si el limite máximo de reajuste del canon de arrendamiento señalado por el Artículo 7° de la Ley
                ...
                <Clause
                    ...
                    title="Entrega"
                >
                    El Arrendatario en la fecha de suscripción de este documento declara recibir el Inmueble de manos
                    del Arrendador saneado, en perfecto estado, de conformidad con el inventario elaborado por las
                    partes (de existir) y que forma parte integrante de este contrato.
                </Clause>

                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Quinta. – Reparaciones: </Text>
                    ...
                    <Para label="Parágrafo">
                        ...
                        estado en que lo recibió del Arrendador, salvo el deterioro natural por el uso legitimo.
                    </Para>
                </View>

                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Sexta. – Servicios Públicos: </Text>
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Séptima. – Destinación: </Text>
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Octava. – Restitución: </Text>
                        ...
                        fijada para la restitución material del Inmueble al Arrendador. Lo anterior puede modificarse a
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Décima Primera. – Incumplimiento: </Text>
                    ...
                    <View style={s.listItem}>
                        ...
                        <Text style={s.listText}>
                            Declarar terminado este Contrato y reclamar la devolución por vía policial, judicial y/o
                            extrajudicialmente;
                        </Text>
                    </View>
                    <View style={s.listItem}>
                ...
                <View style={s.clauseWrap}>
                    <Text style={s.clauseText}>
                        <Text style={s.clauseTitleInline}>Décima Tercera. – Merito Ejecutivo: </Text>
                ...
                <Clause number="Décima Quinta">
                    El Arrendatario autoriza al Arrendador (de ser necesario) a buscar y obtener informacion sobre sus
                    posibles salarios, tiulos y propiedades en entiedades tanto privadas como publicas; como lo pueden
                    ser: bancos, instituciones de credito, la Oficina de Registro de Instrumentos Publicos, entre otros.
                </Clause>
                ...
                >
                    ...
                    del capitulo VII de la ley 820 de 2003.
                </Clause>
                ...
                >
                    ...
                    Contrato a consultar información del Arrendatario que obre en las bases de datos de información
                    privada, estatal o gubernamental del comportamiento financiero y crediticio, o centrales de riesgo
                ...
                {hasCoarrendatario ? (
                    <View style={s.clauseWrap}>
                        <Text style={s.clauseText}>
                            <Text style={s.clauseTitleInline}>Vigésima Primera. – Coarrendatarios: </Text>
                            {
                            ...
                            {` mayor de edad, identificado(a) con ${coarrendatario!.tipoDocumento || 'cedula de ciudadanía'} No. `}
